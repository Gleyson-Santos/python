...
# print(re.findall(r'[a-zA-Z0-9À-ù]+', texto))
...
# print(re.findall(r'\S+', texto, flags=re.A))
# print(re.findall(r'\bb\w+', texto, flags=re.A))
# print(re.findall(r'\w+b\b', texto, flags=re.A))
# print(re.findall(r'\b\w{5}\b', texto, flags=re.A))
